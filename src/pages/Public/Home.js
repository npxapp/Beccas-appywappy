...
import AccordionContentByTerms from 'pages/Public/components/AccordionContentByTerms';
...
const Home = () => {
  ...
  const accordionItems = [
    ...
    },
    {
      ...
      title: 'Components',
      icon: <CodeIcon />,
      content: [{ icon: <IntegrationInstructionsIcon />, text: 'Integrations' }],
    },
    {
      id: 'panel4',
      title: 'APIs',
  ...
  return (
    ...
    >
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', flexGrow: 1, width: '100%', mb: 4 }}>
