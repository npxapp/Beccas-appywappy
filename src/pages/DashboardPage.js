                ...
                <Grid container>
                  <Grid item xs={12}>
                   <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', }}>
                    ...
                    <Chip icon={<PageIcon />} label="Pages" size="small" />
                    <Chip icon={<LinkIcon />} label="Links" size="small" />
                    <Chip icon={<PersonIcon />} label="People" size="small" />
                    <Chip icon={<ApiIcon />} label="APIs" size="small" />
