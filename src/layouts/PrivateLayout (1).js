...
import getTheme from 'themes/PrivateTheme';
        ...
        <AppBar position="static" color="default" elevation={1}>
          <Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <Select
              ...
              onChange={handleSubmit(handleLanguageChange)}
              sx={{
                border: 'none !important',
                borderRadius: "50%",
                overflow: "hidden", // Ensures the round shape is maintained
                width: "2.3rem", // Adjust as needed for a perfect circle
                height: "2.3rem", // Match width for a circular shape
                textAlign: "center", // Centers text inside
                padding: 0, // Removes extra padding that might break the shape
              }}
            >
