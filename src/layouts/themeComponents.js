...
export const componentStyles = (darkMode, isXs) => ({
  ...
  MuiAccordion: {
    ...
    styleOverrides: {
      root: {
        background: darkMode ? `linear-gradient(135deg, rgba(97,218,251,0.15) 0%, rgba(97,218,251,0.05) 100%)` : 'initial',
        backdropFilter: 'blur(8px)',
        borderRadius: 8,
        marginBottom: '4px',
        position: 'relative',
        boxShadow: darkMode ? 'inset 0 2px 8px rgba(97,218,251,0.2), inset 0 -2px 8px rgba(0,0,0,0.3)' : 'initial',
        '&:before': {
          display: 'none',
        },
        color: 'white',
  ...
  MuiAccordionSummary: {
        ...
        '& .MuiSvgIcon-root': {
          color: theme.palette.text.primary,
            ...
            '& .MuiAccordionSummary-content .MuiTypography-root': {
              ...
              color: darkMode ? theme.palette.secondary.main : 'initial',
            },
          },
    ...
    styleOverrides: {
      root: ({ theme }) => ({
        ...
        '& .MuiSvgIcon-root': {
          color: darkMode ? 'rgba(97,218,251,0.8)' : theme.palette.text.primary,
        },
        '&:hover': {
  ...
  MuiAccordionDetails: {
    ...
    styleOverrides: {
      root: {
        bgcolor: darkMode ? 'rgba(0,0,0,0.3)' : 'initial',
        boxShadow: darkMode ? 'inset 0 2px 4px rgba(0,0,0,0.2)' : 'initial',
        position: 'relative',
        '& .MuiTypography-root': {
          color: 'white',
        },
